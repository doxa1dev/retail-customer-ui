...
@Component({
    selector   : 'cooking-experience',
    templateUrl: './cooking-experience.component.html',
    styleUrls  : ['./cooking-experience.component.scss']
})
export class CookingExperienceComponent
{
    /**
     * Constructor
     *
