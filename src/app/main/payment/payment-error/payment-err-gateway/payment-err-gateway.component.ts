...
@Component({
  selector: 'app-payment-err-gateway',
  templateUrl: './payment-err-gateway.component.html',
  styleUrls: ['./payment-err-gateway.component.scss']
})
export class PaymentErrGatewayComponent implements OnInit {
  title = Title.LEFT;
  orderID : string;
